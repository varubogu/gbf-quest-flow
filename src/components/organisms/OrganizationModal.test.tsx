...
vi.mock('@headlessui/react', () => {
  ...
  function TabGroup(props) {
    const { children, selectedIndex, onChange, className } = props;
    return (
...
describe('OrganizationModal', () => {
  ...
  beforeEach(() => {
    ...
    (useEditModeStoreFacade as any).mockImplementation((selector: Function) => {
